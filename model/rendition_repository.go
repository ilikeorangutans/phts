...
type RenditionRepository interface {
	FindByID(collection db.CollectionRecord, id int64) (Rendition, error)
	FindByPhotoAndRenditionConfigurations(collection db.CollectionRecord, photo Photo, configs RenditionConfigurations) (Renditions, error)
...
func (r *renditionRepoImpl) FindByPhotoAndRenditionConfigurations(collection db.CollectionRecord, photo Photo, configs RenditionConfigurations) (renditions Renditions, err error) {
	if len(configs) == 0 {
...
func (r *renditionRepoImpl) FindByID(collection db.CollectionRecord, id int64) (rendition Rendition, err error) {
