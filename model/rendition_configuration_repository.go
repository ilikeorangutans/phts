...
type RenditionConfigurationRepository interface {
	Save(db.CollectionRecord, RenditionConfiguration) (RenditionConfiguration, error)
...
func (r *renditionConfigRepoImpl) Save(collection db.CollectionRecord, config RenditionConfiguration) (RenditionConfiguration, error) {
