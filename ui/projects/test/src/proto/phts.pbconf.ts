...
/*
  ...
  @NgModule({
    providers: [
      { provide: GRPC_VERSION_SERVICE_CLIENT_SETTINGS, useValue: grpcSettings },
    ],
  })
  export class GrpcConfigModule { }
*/
export const GRPC_VERSION_SERVICE_CLIENT_SETTINGS = new InjectionToken<
  GrpcClientSettings
>('GRPC_VERSION_SERVICE_CLIENT_SETTINGS');
